...
```bash
curl -sL https://github.com/Nativ0-DEV/proxmox-scripts-1/blob/main/lxc/nginx-proxy-manager/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://github.com/Nativ0-DEV/proxmox-scripts-1/blob/main/lxc/nginx-proxy-manager/setup.sh | sh
```
